...
INSERT INTO `quiz` VALUES (1,'What does CSS stand for?','Control Style Sheet','Cascading Style Sheet','Central Style Sheet','Cascading System Sheet','Cascading Style Sheet'),(2,'Which is not a data type in Javascript?','Record','String','Number','Array','Record'),(3,'What does HTML used for?','Event handling','Database interaction','Web page structure and content','Web page styling','Web page structure and content'),(4,'Which is not important for PHP development?','Code','Runtime data','Memory log','Dependencies','Memory log'),(5,'What does HTTP status code 404 indicate?','The server cannot find the requested resource.','The server understands the request, but refuses to authorize the request.','The server cannot process the request due to something that is perceived to be a client error.','The client request has not been completed because it lacks valid authentication credentials.','The server cannot find the requested resource.'),(6,'What type of responses do the HTTP 200 status codes cover?','Failed Responses','Information Responses','Successful Responses','Delayed Responses','Successful Responses'),(7,'Which of the following is not a type of HTTP response?','Redirection Response','Warning Response','Client Error Response','Server Error Response','Warning Response'),(8,'All variables in PHP start with which symbol?','!','$','&','#','$'),(9,'What is the correct way to create a function in PHP?','function myFunction()','new_function()','myFunction()','create myFunction()','function myFunction()'),(10,'Which superglobal variable holds information about headers, paths, and script locations?','$_GET','$_SERVER','$_GLOBALS','$_SESSION','$_SERVER'),(11,'Which operator is used to check if two values are equal and of same data type?','===','!=','==','=!','==='),(12,'What is the correct way to add 1 to the $count variable?','$count=+1','++count','count++;','$count++;','$count++;'),(13,'How do you create a cookie in PHP?','makecookie()','cookieset()','setcookie()','createcookie','setcookie()'),(14,'Web security issues are involved in?','CGI script','Client','Server','All of the above','All of the above'),(15,'In JavaScript, the following loop will execute ________ times.\nfor (x=1; x<11; x++)?','7','10','12','5','10'),(16,'In JavaScript, which of the following is NOT an assignment operator?','+==','=','||','*=','||'),(17,'An organization that hosts its infrastructure in a private cloud can decommission its data center.','Public cloud','Hyper-v host','Hybrid cloud','Hyper-v cloud','Public cloud'),(18,'To delegate permissions to Azure virtual machines simultaneously, deploy the Azure vm to the same region.','The same manager template','The same availability zone','The same resource group','All of the above','The same resource group'),(19,'Which resource is an example of IaaS in Azure?','Azure virtual machine','Azure SQL','Azure web app','Azure logic app','Azure virtual machine'),(20,'What is the Web Technologies professor\'s name?','Tom Richards','Ted Richards','Timothy Richards','Tony Richards','Timothy Richards');
...
-- Dump completed on 2023-11-06 21:11:46
-- MySQL dump 10.13  Distrib 8.0.34, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2023-10-29 17:26:16',NULL),('diagnostics.include_raw','OFF','2023-10-29 17:26:16',NULL),('ps_thread_trx_info.max_length','65535','2023-10-29 17:26:16',NULL),('statement_performance_analyzer.limit','100','2023-10-29 17:26:16',NULL),('statement_performance_analyzer.view',NULL,'2023-10-29 17:26:16',NULL),('statement_truncate_len','64','2023-10-29 17:26:16',NULL);
...
-- Dump completed on 2023-11-06 21:11:49
